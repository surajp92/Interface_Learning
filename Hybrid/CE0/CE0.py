...
for j in range(1,nt+1):
    ...
    futemp = ufdm/3.0  # fu[0,0] #
    fvtemp = vfdm/3.0 # fv[0,0] #
...
fig.tight_layout()
plt.show()
#fig.savefig(f'hybrid0_{nx}.pdf',dpi=300)
#fig.savefig(f'hybrid0_{nx}.png',dpi=300)

#np.savez(f'solution_hybrid_{nx}_{tm}' , x=x, t=t, u=u_all, v =v_all)
